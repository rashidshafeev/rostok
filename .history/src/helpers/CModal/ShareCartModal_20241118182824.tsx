...
const ShareCartModal : React.FC = () => {
  ...
  return (
    ...
    >
          <Box className='absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 lining-nums proportional-nums bg-white rounded-lg border-none outline-none px-6 py-8 w-fit mm:w-full'>
            <span
              onClick={() => {hideModal()
                setUrl(``)
              }}
