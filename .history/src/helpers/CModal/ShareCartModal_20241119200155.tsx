...
const ShareCartModal : React.FC = () => {
  ...
  const { data: shareCode, isLoading, isSuccess, refetch } = useGetCartShareCodeQuery(undefined, { refetchOnMountOrArgChange: true });
  ...
  useEffect(() => {
    setUrl(`https://rosstok.ru/shopping-cart?cart=${shareCode?.code}`);
