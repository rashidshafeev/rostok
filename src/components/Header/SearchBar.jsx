    ...
    <>
      <div className='w-full  '>
        ...
        <div className='flex justify-between z-30 bg-white relative rounded-lg p-2'>
          ...
          {isFocused && results && <div className='absolute bg-white w-full h-full box-content bottom-0 right-0 rounded-lg '>
            <div className='relative min-w-full min-h-full bg-white rounded-lg  bottom-0'>

            </div>
            <div className={`relative min-w-full min-h-0 bg-white rounded-lg bottom-0 mt-2 overflow-hidden  proportional-nums lining-nums ${results.length !== 0 && 'p-1'}`}>
                  ...
                  <NavLink to={`/catalog/${result.categorySlug}/${result.slug}`} onClick={handleBlur}>
                    <div className='flex items-center gap-3'>
                      ...
                      <div>
                        ...
                        <div className=' text-colDarkGray text-xs'>{result.article}</div>
                      </div>
                    </div>
                  </NavLink>
                </li>
              ...
              {/* {results?.categories && <div className=' font-semibold text-2xl px-4 pt-3'>Категории</div>} */}
                    ...
                    <div className='flex items-center gap-3'>
                      ...
                      <div>
                        ...
                        <div className='text-xs text-colDarkGray'>
                          ...
                          <div className='text-sm text-colBlack'>{result.name}</div>
                        </div>
                        <div className=' text-colDarkGray text-xs'>Категория</div>
                      </div>
                    </div>
                  </NavLink>
                </li>
