    ...
    <div className="flex flex-col gap-4 px-5">
      <div className="flex">
        ...
        <div className="text-sm">
          {product && product?.availability?.stock !== 0 && `В наличии ${product.availability.stock} шт.`}
          {product && product?.availability?.stock === 0 && product?.availability?.preorder === null && `Нет в наличии`}
          {product && product?.availability?.preorder !== null && `Нет в наличии, ожидается ${product.availability.preorder.formatted}`}
        </div>
      </div>
{/* 
      <div className="flex">
