...
const FavDetail = ({ favorite }) => {
  return (
    <div className='pb-10 min-h-[560px] md:pl-5'>
      <button
      ...
      <div className='grid grid-cols-2 mm:grid-cols-3 md:grid-cols-2 lg:grid-cols-3 ll:grid-cols-4 gap-3 xl:grid-cols-5 pt-4'>
        {favorite?.map((el) => (
          <Fragment key={el?.id}>
