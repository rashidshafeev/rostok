...
import { useGetCategoryTreeQuery } from '@/api/catalog/categoryTree';
import { useState } from 'react';
import { NavLink } from 'react-router-dom';
import { ArrowIcon } from '@/components/ArrowIcon';
import { SidebarCategoryTreeSkeleton } from '@/components/SidebarCategoryTreeSkeleton';
...
const SidebarCategoryTree: React.FC<SidebarCategoryTreeProps> = ({ categories, isLoading, isSuccess }) => {
